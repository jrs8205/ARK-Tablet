...
public class BatteryMonitor {
    ...
    /** Time-based polling period: once every 10 min, offset xx:01/11/21/31/41/51. */
    ...
    private final Runnable pollTask = new Runnable() {
        @Override public void run() {
            // Read the sticky broadcast. This works even if the system has not sent
            // an ACTION_BATTERY_CHANGED event in a long time (e.g. the A9+'s
            // Samsung maximum mode holds the battery at 80% and sends no updates).
