...
public class WeatherSample {
    ...
    /** FMI wawa code (WMO 0–99) taken directly from the observation row. Deterministic,
     *  independent of when the forecast was fetched. Used as the source of truth for
     *  history charts; weatherSymbol remains a legacy field for old rows and for
     *  forecast-based UI debugging. NULL if the observations had no wawa value. */
