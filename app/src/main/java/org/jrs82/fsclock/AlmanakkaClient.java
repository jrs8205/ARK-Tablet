...
/** Public name day API of the University of Helsinki Almanac Office.
 *  Endpoint: https://namedays.tm-tieto.fi/api/public/namedays-search (POST, JSON).
 *  Free tier: max 100 queries/h, requires attribution.
 *  This class returns only names of type "suomi" (Finnish). */
public class AlmanakkaClient {
    ...
    /** Returns the Finnish names for the given day, comma-separated, e.g. "Maila, Maili, Mailis". */
