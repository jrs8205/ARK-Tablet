...
public class MainActivity extends Activity {
    ...
    protected void onResume() {
        super.onResume();
        // After returning from SettingsActivity, force a brightness re-apply so
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        // Navigation and status bars can reappear after system gestures,
        // dialogs, or other Activities — restore immersive mode whenever
        // this Activity regains focus.
